...
const ArticlePage = async ({ params }: { params: ParamsType }) => {
	...
	return (
        ...
        <div className="flex flex-col p-4 my-8 mx-auto  shadow-xl shadow-red-200 rounded-lg basis-[27em] lg:basis-[36em] xl:basis-[48em] flex-grow flex-shrink">
            ...
            <Image src={article?.image && `${process.env.NEXT_PUBLIC_STRAPI_URL}${article?.image.url}` || "/no-image.svg"} alt={article?.image?.name || ""} width={1000} height={600} className="w-[45em] h-auto object-cover mx-auto rounded-xl mb-8 " />
